package me.koldskal.kACT.utils.item;
...
public final class ItemBuilder {
    ...
    public ItemBuilder(Material material, int i, byte b, String name, String... lore) {
    ...
    public ItemBuilder colorizeLore() {
        if (this.itemMeta.hasLore()) {
            ...
            lore.replaceAll(Colorize::colorize);
    ...
    public ItemBuilder colorizeName() {
        if (this.itemMeta.hasDisplayName()) this.name(Colorize.colorize(this.getItemMeta().getDisplayName()));
        return this;
    }
